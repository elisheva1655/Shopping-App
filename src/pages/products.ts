import animalEraser from './images/animal-erasers.png';
import bearPencilCase from './images/bear-pencil-case.png';
import binderClip from './images/binder-clips.png';
import bunnyGelPen from './images/bunny-gel-pen-set.png'
import cloudStickyNote from './images/cloud-sticky-notes.png';
import colorfulTape from './images/colorful-tape-set.png';
import doodleNotebook from './images/doodle-notebook.png';
import frogSticker from './images/frog-stickers.png';
import highlighter from './images/highlighter-set.png';
import startStickyNote from './images/start-sticky-notes.png';
import toDoList from './images/to-do-list.png';
import weeklyCalendar from './images/weekly-calendar.png';
type Product = {
    id: string;
    name: string;
    description: string;
